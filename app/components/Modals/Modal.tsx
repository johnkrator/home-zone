...
const Modal: React.FC<IModalProps> = ({
    ...
    return (
        <>
            <div
                className="md:px-0 px-5 justify-center items-center py-40 flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70">
                <div
