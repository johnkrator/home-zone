...
const Modal: React.FC<IModalProps> = ({
    ...
    return (
        <>
            <div
                className="md:px-0 px-5 justify-center items-center lg:py-40 flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70">
                <div
                    className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-full lg:h-full lg:h-auto md:h-auto">
                    {/*content*/}
